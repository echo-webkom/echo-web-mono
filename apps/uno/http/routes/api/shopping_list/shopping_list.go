...
func (s *shoppingList) getShoppingList(ctx *handler.Context) error {
	...
	// Convert to DTO
	response := ShoppingListFromDomainList(shoppingList)
...
// @Accept       json
// @Produce      json
// @Param        request  body  CreateShoppingListItemRequest  true  "Create Shopping List Item Request"
...
// @Accept       json
// @Produce      json
// @Param        request  body  UserToShoppingListItemRequest  true  "User to Shopping List Item Request"
// @Success      200  {string}  "OK"
// @Failure      400  {string}  string  "Bad Request"
// @Failure      401  {string}  string  "Unauthorized"
// @Failure      500  {string}  string  "Internal Server Error"
