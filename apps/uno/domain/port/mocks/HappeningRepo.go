...
// GetHappeningBySlug provides a mock function for the type HappeningRepo
func (_mock *HappeningRepo) GetHappeningBySlug(ctx context.Context, slug string) (model.Happening, error) {
	ret := _mock.Called(ctx, slug)
...
// HappeningRepo_GetHappeningBySlug_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHappeningBySlug'
type HappeningRepo_GetHappeningBySlug_Call struct {
	*mock.Call
}
...
func (_c *HappeningRepo_GetHappeningBySlug_Call) Run(run func(ctx context.Context, slug string)) *HappeningRepo_GetHappeningBySlug_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *HappeningRepo_GetHappeningBySlug_Call) Return(happening model.Happening, err error) *HappeningRepo_GetHappeningBySlug_Call {
	_c.Call.Return(happening, err)
	return _c
}

func (_c *HappeningRepo_GetHappeningBySlug_Call) RunAndReturn(run func(ctx context.Context, slug string) (model.Happening, error)) *HappeningRepo_GetHappeningBySlug_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *HappeningRepo) GetHappeningRegistrations(ctx context.Context, happeningID string) ([]model.HappeningRegistration, error) {
	ret := _mock.Called(ctx, happeningID)
	...
	var r0 []model.HappeningRegistration
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]model.HappeningRegistration, error)); ok {
		return returnFunc(ctx, happeningID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []model.HappeningRegistration); ok {
		r0 = returnFunc(ctx, happeningID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.HappeningRegistration)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string) error); ok {
		r1 = returnFunc(ctx, happeningID)
...
func (_c *HappeningRepo_GetHappeningRegistrations_Call) Return(happeningRegistrations []model.HappeningRegistration, err error) *HappeningRepo_GetHappeningRegistrations_Call {
	_c.Call.Return(happeningRegistrations, err)
	return _c
}

func (_c *HappeningRepo_GetHappeningRegistrations_Call) RunAndReturn(run func(ctx context.Context, happeningID string) ([]model.HappeningRegistration, error)) *HappeningRepo_GetHappeningRegistrations_Call {
	_c.Call.Return(run)
	return _c
}
