...
func RequireAuthMiddleware(s *services.SessionService) Middleware {
...
func WithAuth(s *services.SessionService, h AuthHandler) Handler {
...
func WithOptionalAuth(s *services.SessionService, h OptionalAuthHandler) Handler {
	return func(ctx *Context) error {
		auth, ok := getAuthFromRequest(s, ctx.R)
...
func getAuthFromRequest(s *services.SessionService, r *http.Request) (auth model.Auth, ok bool) {
