...
export default function NotFound() {
  ...
  return (
    <Container className="relative pb-40 pt-24" layout="full">
      {/* <SiteHeader /> */}
      <div className="min-h-screen bg-[#d7d7da] text-primary selection:bg-gray-800/60">
        <main className="mx-auto max-w-3xl space-y-10 px-4 py-20 text-xl md:text-xl">
          <h1 className="text-3xl md:text-2xl">Finner ikke siden du ser etter...</h1>
