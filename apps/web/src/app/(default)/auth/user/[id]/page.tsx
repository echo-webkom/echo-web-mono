...
import { auth, getProfileOwnerInfo } from "@/auth/session";
...
export default async function ProfilePage({ params }: { params: { id: string } }) {
  ...
  const profileOwner = await getProfileOwnerInfo(ownerId);
  ...
  const hasAccess = getProfileOwnerInfo(ownerId) || isProfileOwner;
