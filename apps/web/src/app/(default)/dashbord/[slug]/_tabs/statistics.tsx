...
export const StatisticsTab = async ({ happening, registrations }: StatisticsTabProps) => {
  ...
  const attended = registrations.filter((registration) => registration.attended === true)
  ...
  return (
    <div className="mt-8 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <Stat title="Andel møtt opp" value={Math.trunc((attended.length / registered.length)*100).toString() + "%"}/>
      </div>
