...
const content = `# Personvernerklæring
...
Når du melder deg på arrangement i regi av echo, vil vi av og til spørre om helserelatert info som allergier. Dette er for å ivareta dine interesser. Sensitive spørsmål blir også slettet hver 6 måned fra vår database.
