...
<Callout>Props er read-only, og kan ikke endres av komponenten som mottar dem.</Callout>

<Callout>
  Du kan bruke destructuring for å hente ut props fra et objekt. Dette er den anbefalte måten å
  hente ut props på.
