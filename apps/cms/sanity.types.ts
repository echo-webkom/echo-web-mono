...
// Variable: merchQuery
// Query: *[_type == "merch" && !(_id in path('drafts.**'))] | order(_createdAt desc) {  _id,  _createdAt,  _updatedAt,  title,  "slug": slug.current,  title,  text,  slug,  cost,  image,}
export type MerchQueryResult = Array<{
  _id: string;
  _createdAt: string;
  _updatedAt: string;
  title: string;
