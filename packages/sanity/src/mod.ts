...
export const projectId = Deno.env.get("NEXT_PUBLIC_SANITY_PROJECT_ID") ?? DEFAULT_PROJECT_ID;
export const dataset = Deno.env.get("NEXT_PUBLIC_SANITY_DATASET") ?? DEFAULT_DATASET;
